...
///
/// Temporarily disabled so the app can be used without a subscription.
/// Restore the original checks when subscription is implemented again.
...
class SubscriptionExpiredBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Subscription banners are temporarily disabled.
