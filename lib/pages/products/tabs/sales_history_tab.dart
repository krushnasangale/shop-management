        ...
        child: Row(
          children: [
            ...
            HistoryMetric(
              ...
              value: '${context.currencySymbol}${(stats['totalRevenue'] as num).toStringAsFixed(0)}',
            ),
            HistoryMetric(
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text(
                            '${context.currencySymbol}${sale['total'] ?? 0}',
                            style: TextStyle(
                              fontSize: 14,
                      ...
                      if (isExpanded) ...[
                        ...
                        Row(
                          children: [
                            HistoryMetric(
                              label: loc?.buy ?? 'Buy',
                              value: '${context.currencySymbol}${sale['buyingPrice']}',
                            ),
                            HistoryMetric(
                              label: loc?.sell ?? 'Sell',
                              value: '${context.currencySymbol}${sale['sellingPrice']}',
                            ),
                            HistoryMetric(
